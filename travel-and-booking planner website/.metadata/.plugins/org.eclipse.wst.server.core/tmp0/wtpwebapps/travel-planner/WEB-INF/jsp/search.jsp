        ...
        <div class="destinations-grid">
            ...
            %>
                <div class="destination-card">
                    ...
                    <form action="${pageContext.request.contextPath}/hotels" method="get">
                    <input type="hidden" name="destinationId" value="<%= dest.getId() %>">
                    <button class="book-btn" type="submit"><i class="fa fa-hotel"></i> Book</button>
                    </form>
                </div>
            <%
                    }
